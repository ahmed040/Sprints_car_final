...
//#define TCNT1H *((reg_type8)(0x53))
//#define TCNT1L *((reg_type8)(0x53))
#define TCNT1 *((reg_type16)(0x4C))
//#define OCR1AH *((reg_type8)(0x53))
//#define OCR1AL *((reg_type8)(0x53))
#define OCR1A *((reg_type16)(0x4A))
//#define OCR1BH *((reg_type8)(0x53))
//#define OCR1BL *((reg_type8)(0x53))
#define OCR1B *((reg_type16)(0x48))
//#define ICR1H *((reg_type8)(0x53))
//#define ICR1L *((reg_type8)(0x53))
